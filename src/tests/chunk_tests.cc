...
static void chunk_tests(TestSuite &s) {
    ...
    s.assert_eq(chatter::range_chunk(chatter::character, 51, 100, string).get(),
    ...
    s.assert_eq(chatter::range_chunk(chatter::word, 0, 5, string).get(),
                "firstly, line 1 of the string");
    s.assert_eq(chatter::range_chunk(chatter::word, 6, 7, string).get(), "then, line");
    s.assert_eq(chatter::range_chunk(chatter::word, 9, 100, string).get(),
                "lastly, line 3 of the string\n");
    ...
    s.assert_eq(chatter::range_chunk(chatter::item, 0, 1, string).get(),
                "firstly, line 1 of the string\nthen");
    s.assert_eq(chatter::range_chunk(chatter::item, 1, 2, string).get(),
                " line 1 of the string\nthen, line 2\nlastly");
    s.assert_eq(chatter::range_chunk(chatter::item, 2, 100, string).get(),
                " line 2\nlastly, line 3 of the string\n");
    ...
    s.assert_eq(chatter::range_chunk(chatter::line, 0, 1, string).get(),
                "firstly, line 1 of the string\nthen, line 2");
    s.assert_eq(chatter::range_chunk(chatter::line, 1, 2, string).get(),
                "then, line 2\nlastly, line 3 of the string");
    s.assert_eq(chatter::range_chunk(chatter::line, 2, 100, string).get(),
                "lastly, line 3 of the string\n");

    s.assert_eq(chatter::last_chunk(chatter::line, string).get(), "lastly, line 3 of the string");

    s.assert_eq(chatter::random_chunk(
