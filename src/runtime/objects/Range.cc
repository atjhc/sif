...
Result<Value, Error> Range::subscript(VirtualMachine &vm, SourceLocation location,
...
Result<Value, Error> Range::setSubscript(VirtualMachine &vm, SourceLocation location,
